    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                } else if (attr == R.styleable.EasySwipeMenuLayout_leftSwipeEnable) {
                    mCanLeftSwipe = typedArray.getBoolean(R.styleable.EasySwipeMenuLayout_leftSwipeEnable, true);
                } else if (attr == R.styleable.EasySwipeMenuLayout_rightSwipeEnable) {
                    mCanRightSwipe = typedArray.getBoolean(R.styleable.EasySwipeMenuLayout_rightSwipeEnable, true);
